...
export const findAllAnimales = async (req: Request, res: Response): Promise<void> => {
    try{
...
export const getOneAnimal = async (req: Request, res: Response): Promise<void> => {
    try{
...
export const registrarAnimalController = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const eliminarAnimal = async (req: Request, res: Response): Promise<void> => {
    try{
        const nro = parseInt(req.params.nro, 10);
        if (isNaN(nro)) {
            res.status(400).json({ message: 'Número de animal inválido' });
